...
public class HelloWorldContactHandler extends
    ...
    @Override
    public Object getFeature(String connectorType, ContactConnectorManager
            .ConnectorFeature feature, String contactUID, String connectorAddress) {
        return null;
    }

    @Override
    public String getDescription() {
        return "Contact handler for the " + pluginContext.getString(R.string.app_name);
    }
}
