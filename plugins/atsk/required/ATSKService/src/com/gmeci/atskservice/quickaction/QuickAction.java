...
package com.gmeci.atskservice.quickaction;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
    ...
    public void setRootViewId(int id) {
        ...
        mArrowDown = (ImageView) mRootView
                .findViewById(R.id.quickaction_arrow_down);
        mArrowUp = (ImageView) mRootView
                .findViewById(R.id.quickaction_arrow_up);
    ...
    public interface OnActionItemClickListener {
        void onItemClick(QuickAction source, int pos,
                int actionId);
    }
