...
public class UploadChooserActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = FileProvider.getUriForFile(this,"com.atakmap.android.wildfiredln.plugin.fileprovider",new File(resourcesDirectory,"wdlnCamera.png"));

        Log.d(TAG,"Granting access to "+resourcesDirectory.getAbsolutePath()+"/"+uri.toString());
        this.grantUriPermission("com.atakmap.app.civ",uri,Intent.FLAG_GRANT_READ_URI_PERMISSION);
