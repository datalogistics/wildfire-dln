...
public class PluginTemplateTool extends Tool implements ToolDescriptor {
    ...
    public Drawable getIcon() {
        return (context == null) ? null : context.getResources().getDrawable(R.drawable.wdln_48x48);
    }
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2, Bundle arg3,
        ...
        Intent i = new Intent(PluginTemplateDropDownReceiver.SHOW_PLUGIN_TEMPLATE);
