    ...
    public void run()
    {
        try
        {
            ...
            if(reachable)
            {
                ...
                Log.d(TAG,"Trying HTTP connection to http://"+IPString + ":/web/");
                URL url = new URL("http://"+IPString + "/web/");
                ...
                try
                {
                    ...
                    Log.d(TAG, "http://"+IPString + "/web/ -- Response"+responseString);
                ...
                if(!failed)
                {
                    ...
                    {
                        //Log.d(TAG, Log.getStackTraceString(e));
                        Log.d(TAG,"Could not find node list for "+IPString);
                        nreferences = new Vector<NodeReference>();
                        //failed = true;
                    }
                    catch (IOException e)
                    {
