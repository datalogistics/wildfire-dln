...
This is the Up Board-specific backend, relying on the MRAA libraries. Another version,
designed for the Raspberry Pi, utilizes the equivalent WiringPi.
