...
*/
    ...
    //MagneticModel->ModelName = 'WMM-2010';
    ...
    while(counter < 90)
    {
        ...
        n=WMM_COF_2010[counter][0];
        m=WMM_COF_2010[counter][1];
        
        if (m <= n)
        {
            index = (n * (n + 1) / 2 + m);

            gnm=WMM_COF_2010[counter][2];
            hnm=WMM_COF_2010[counter][3];
            dgnm=WMM_COF_2010[counter][4];
            dhnm=WMM_COF_2010[counter][5];
