...
public class QuickAction extends PopupWindows {
    ...
    private static final int LIGHT_BLUE = 0x33b5e5;
    /**
     * Add action item
     *
    ...
    public void setRootViewId(int id) {
        ...
        mArrowDown = (ImageView) mRootView.findViewById(R.id.popup_arrow_down);
        mArrowUp = (ImageView) mRootView.findViewById(R.id.popup_arrow_up);
    ...
    public void addActionItem(ActionItem action) {
        ...
        View container = inflater.inflate(R.layout.atsk_action_item,
                null);

        ImageView img = (ImageView) container.findViewById(R.id.iv_icon);
        //PAWLOS - here is where we define the text shown in the quick action box.
        TextView text = (TextView) container.findViewById(R.id.tv_title);
        text.setTextColor(LIGHT_BLUE);
    ...
    public void show(View anchor) {
        ...
        showArrow(((onTop) ? R.id.quickaction_arrow_down
                : R.id.quickaction_arrow_up), anchorRect.centerX() - xPos);
    ...
    private void showArrow(int whichArrow, int requestedX) {
        final View showArrow = (whichArrow == R.id.quickaction_arrow_up) ? mArrowUp
                : mArrowDown;
        final View hideArrow = (whichArrow == R.id.quickaction_arrow_up) ? mArrowDown
                : mArrowUp;
